 ...
 */
import { SelectorKey, Features, StateType, StoreProps, DataProps, GetState, SetState, GetStore, ResetState } from "./Core.interfaces";
...
export default class Payload<T = StateType, S = StoreProps, D = DataProps> implements IPayload<T, S, D> {
