...
import {Store as CoreStore } from '@neurongsm/core';
import {setSlice, Selector} from '@neurongsm/slices';

export type UseStore<State = {[key:string]: unknown}> = (Store: CoreStore<State>) => [{[key:string]: unknown}, unknown];
